...
The 'enterprise_api_ingestion_platform' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/enterprise_api_ingestion_platform/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] enterprise_api_ingestion_platform_etl` to your workspace.
